...
public class AutenticacaoProvider implements AuthenticationProvider {
    ...
    public AutenticacaoProvider(AutenticacaoService usuarioAutorizacaoService, PasswordEncoder passwordEndcoder) {
    ...
    public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
        ...
        if (this.passwordEndcoder.matches(password, userDetails.getPassword())) {
